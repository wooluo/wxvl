#  漏洞复现 | 山东启恒信息科技有限公司数智化平台 CommonHandler 存在SQL注入漏洞  
 实战安全研究   2026-09-10 01:00  
...
山东启恒信息科技有限公司数智化平台 CommonHandler 存在SQL注入漏洞，未经身份验证的远程攻击者除了可以利用SQL注入漏洞获取数据库中的信息（例如，管理员后台密码、站点的用户个人信息）之外，甚至在高权限的情况可向服务器中写入木马，进一步获取服务器系统权限。  
...
fofa语法  
```
icon_hash=1409809372
```  
  
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtorkOQCLRmXrXV6oSbaiccRQBLfbDRzJGLhmEia8va3laLzb5mVUelibB8w023k7iahdAr1rcgPl5DE83XycdL0HhB28GmibFXkuIXlA/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtood0DTYjRGfABs4vbXlEmNlErItzrJjWpAQCcagRjqs0vdxfyhs48G5KjXQ1gyDJicjzaEePoUv17CkQPtUs4cxyAUFrmwZy8qA/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtopHHw5wSsZqpHO5H2EhSt1pM3Tw5ic0yVemgn3fT73jlbWfLfCBczicah9CPhxnvTYOP1mBnzhYCaj6MY3lwGTdc2tdFTSfhNUTs/640?wx_fmt=png&from=appmsg "")  
  
afrog  
  
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtor017E75F6le1ib360mXlcLr6oK2KZwkyH0D1y8nsmftADET5v1CSWRJ8cbK3N8HPLgomwtrKzoj8I3HIMAhzsYBqCldgyHAcD8/640?wx_fmt=png&from=appmsg "")  
