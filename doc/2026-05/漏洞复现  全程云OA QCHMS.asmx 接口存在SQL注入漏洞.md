#  漏洞复现 | 全程云OA QCHMS.asmx 接口存在SQL注入漏洞  
 实战安全研究   2026-05-03 02:54  
...
全程云OA QCHMS.asmx 接口存在SQL注入漏洞，  
未经身份验证的远程攻击者除了可以利用SQL注入漏洞获取数据库中的信息（例如，管理员后台密码、站点的用户个人信息）之外，甚至在高权限的情况可向服务器中写入木马，进一步获取服务器系统权限。  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtorzqdPiaiaMRnzeARqUdg8gNDsM26ApRiaeCZo3GcwEUC67asBwpcFv0wDqibRjPXt9UN2QBpDIvLD6uAz4EovkQ9kyCapyvf42Sug/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/yIciaKAicYtoqyiacld6Lu1k02dsDO9cXIKV6gJHS0I8DS7IP5iaiacGnPR319UzWynFcC7IIia1KMv33aArxYGy2t7naxGWV608CzCUQQjQvCYpM/640?wx_fmt=jpeg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtooMPnQPw9PlPmTkuRTbbuedMQhibn2uyXicibn4nqD4D9VUPH1dnOv5ia19jMHkSW9sThW1G9n8RztBEIxgibvhdBF43Orsgb3jiaMNw/640?wx_fmt=png&from=appmsg "")  
  
afrog  
  
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtoqr9BdZ24WWHvfkHIjdd6uwm1UPORE1uP7xZRaOuITWQqudr2vZXSHvfSdB4icx66rYJkMkzpXIK55AaukuKkGLpCMaG0BA1Yz4/640?wx_fmt=png&from=appmsg "")  
