...
1. 活动期间，实行动态累计积分制，每提交一个有效漏洞，即可获得相应积分，达到门槛自动晋升段位，解锁更高奖励  
...
*收集范围仅限银联产权域名，且同一应用同一类型越权漏洞、未授权漏洞仅收录  
前 3 个  
  
1. 冲榜赛根据提交漏洞的数量/严重性，授予不同段位。  
...
活动期间新注册的白帽子，提交总、分、子公司辖内系统任意1个有效漏洞可获得  
新人好礼  
