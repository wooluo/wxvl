...
🚀哈喽～各位宝子们周五下午好~~👋！今日为大家带来的是关于某科技 X2Modbus网关 GetConfig 信息泄露漏洞，干货十足，手把手教你复现，接下来进行详细的报道； 以下的详细内容👇  
## 2. 漏洞详情  
### 漏洞描述  
  
某科技 X2Modbus网关 GetConfig 存在信息泄露漏洞，未经身份验证的远程攻击者可利用此漏洞获取数据库用户密码等敏感信息，从而登录数据库，使数据库处于极不安全的状态。  
### 影响版本  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvKDZJSJcnIYbXialE6cjiagg08H40xFzKzBP7CcvJGCk6bVfrC9NdEwUF6CER4hNqcNxRiavyib0UribMGkMbCZ9s1rUw9o1fAzqA6s/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvKqtiaTbLlwsZPoTfacpM9Oh3ibzibpSQKw7ThCS8R6MhCzRwv3nqqKyCtKVVXat9sibMxjezLzf8BcCoZ8lvf6w9oktbRYEmjBXVg/640?wx_fmt=png&from=appmsg "")  
## 3. 如何使用好靶场  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvLibWDibSf5kxb6mCMkDJrDypssae0TI0M7ImRDaVFs6HqmqItOKfo8RnF2KleC3Qicd3Wp9YK5Wc2QiazKGicsxHcAGQHZwuichxwSE/640?wx_fmt=png&from=appmsg "")  
  
你可以尝试问一下关于打靶场的问题  
  
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvJnDdcrwGAkAnz0EH65bPVkPicWIb0DDr275KEoCwicHeEmAITXKPMmHIcabxaT7cKNbp14OJCmU84Y1X2lW9233cMwkddEqWDJ8/640?wx_fmt=png&from=appmsg "")  
## 🚀好靶场会员订阅  
