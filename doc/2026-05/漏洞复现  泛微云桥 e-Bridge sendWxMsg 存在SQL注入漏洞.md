#  漏洞复现 | 泛微云桥 e-Bridge sendWxMsg 存在SQL注入漏洞  
 实战安全研究   2026-05-01 01:01  
...
泛微云桥 e-Bridge sendWxMsg 存在SQL注入漏洞，未经身份验证的远程攻击者除了可以利用SQL注入漏洞获取数据库中的信息（例如，管理员后台密码、站点的用户个人信息）之外，甚至在高权限的情况可向服务器中写入木马，进一步获取服务器系统权限。  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtor24PnCJYx3raQy8Vlq3WdP2XKMmMEia0LtzyLdEnDXnfZDqyJG25AtzP1OkfO2EkcPYNxdrQYZvSia9KicSlckQo1cox0uzMHYbU/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtooq2s5T7KiauVO1mJ0xKEAgUia1oEfu9KQDYcOdHdwTrF9LREy0gKTXY3gMrR3q8XCVKlNyMnbJQRR9z4MmFjnQ23KZm6RsaeouI/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtorUYR4BIqibHuB7nRLdnmCCuicuyPEYSdvHcvr5QicQvJV4e6GDfVgs3OBhicicF9WfKuzQYQgxWXdsXoUG96vGQTswPE0IzgezoiaPc/640?wx_fmt=png&from=appmsg "")  
  
afrog  
  
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtoqvCNDq1Wf3WrLIwHfVDfic6VNHicBNgupwtuKn6X4hUwPuZv2zMuNrv9y4GNwbGB8jM3cnkyfKsKdWwcn6iaW0SuacZM0IFgAkNQ/640?wx_fmt=png&from=appmsg "")  
