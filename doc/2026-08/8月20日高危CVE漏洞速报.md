...
## 漏洞详情  
<table><tbody><tr><td style="white-space: nowrap;vertical-align: middle;"><span style="color:#c0392b;font-size:12px;font-weight:bold;padding:3px 10px;border:1px solid #c0392b;border-radius:3px;"><span leaf="">严重</span></span></td><td style="vertical-align:middle;padding-left:10px;"><span style="font-size:17px;font-weight:bold;color:#7c1d1d;"><span leaf="">CVE-2026-33824</span></span></td><td style="white-space: nowrap;vertical-align: middle;text-align: right;"><span style="color:#c0392b;font-size:12px;font-weight:bold;"><span leaf="">CVSS 9.8</span></span></td></tr></tbody></table>### Windows IKE 扩展 Double Free 未认证 RCE（CVSS 9.8·CISA KEV·EPSS 56%）  
...
<table><tbody><tr><td style="white-space: nowrap;vertical-align: middle;"><span style="color:#c0392b;font-size:12px;font-weight:bold;padding:3px 10px;border:1px solid #c0392b;border-radius:3px;"><span leaf="">严重</span></span></td><td style="vertical-align:middle;padding-left:10px;"><span style="font-size:17px;font-weight:bold;color:#7c1d1d;"><span leaf="">CVE-2026-65400</span></span></td><td style="white-space: nowrap;vertical-align: middle;text-align: right;"><span style="color:#c0392b;font-size:12px;font-weight:bold;"><span leaf="">CVSS 9.8</span></span></td></tr></tbody></table>### macOS Screen Sharing 认证绕过致 root 权限（CVSS 9.8·CISA KEV·挖矿利用）  
...
<table><tbody><tr><td style="white-space: nowrap;vertical-align: middle;"><span style="color:#c0392b;font-size:12px;font-weight:bold;padding:3px 10px;border:1px solid #c0392b;border-radius:3px;"><span leaf="">严重</span></span></td><td style="vertical-align:middle;padding-left:10px;"><span style="font-size:17px;font-weight:bold;color:#7c1d1d;"><span leaf="">CVE-2026-19478</span></span></td><td style="white-space: nowrap;vertical-align: middle;text-align: right;"><span style="color:#c0392b;font-size:12px;font-weight:bold;"><span leaf="">CVSS 9.4</span></span></td></tr></tbody></table>### GitLab GraphQL 代码注入未认证删库（CVSS 9.4·供应链攻击风险）  
  
GitLab GraphQL 层在处理 @gl_introduced 指令时存在 fallback 字段解析缺陷（代码注入），攻击者可借助该指令触发任意 ActiveRecord 公开方法调用，在无需任何身份验证的情况下，通过单个恶意请求永久删除公共项目数据、停用或封禁用户账号、修改关键状态信息，甚至对开源项目发起供应链攻击。GitLab 于 8 月 17 日发布紧急补丁 19.2.4 / 19.1.6 / 19.0.8 / 18.11.11，GitLab.com 与 GitLab Dedicated 已自动修复，所有 self-managed（自托管）实例需立即升级。代码托管平台是企业 CI/CD 与知识产权的核心节点，失陷将直接威胁软件交付与业务连续性。  
...
<table><tbody><tr><td style="white-space: nowrap;vertical-align: middle;"><span style="color:#c0392b;font-size:12px;font-weight:bold;padding:3px 10px;border:1px solid #c0392b;border-radius:3px;"><span leaf="">严重</span></span></td><td style="vertical-align:middle;padding-left:10px;"><span style="font-size:17px;font-weight:bold;color:#7c1d1d;"><span leaf="">CVE-2026-15826</span></span></td><td style="white-space: nowrap;vertical-align: middle;text-align: right;"><span style="color:#c0392b;font-size:12px;font-weight:bold;"><span leaf="">CVSS 9.8</span></span></td></tr></tbody></table>### WordPress User Profile Builder 类型混淆认证绕过（CVSS 9.8·4 万+站点）  
...
<table><tbody><tr><td style="white-space: nowrap;vertical-align: middle;"><span style="color:#c0392b;font-size:12px;font-weight:bold;padding:3px 10px;border:1px solid #c0392b;border-radius:3px;"><span leaf="">严重</span></span></td><td style="vertical-align:middle;padding-left:10px;"><span style="font-size:17px;font-weight:bold;color:#7c1d1d;"><span leaf="">CVE-2025-62593</span></span></td><td style="white-space: nowrap;vertical-align: middle;text-align: right;"><span style="color:#c0392b;font-size:12px;font-weight:bold;"><span leaf="">CVSS 9.4</span></span></td></tr></tbody></table>### Ray-Project Ray 代码注入远程执行（CVSS 9.4·AI/ML 框架·浏览器触发）  
