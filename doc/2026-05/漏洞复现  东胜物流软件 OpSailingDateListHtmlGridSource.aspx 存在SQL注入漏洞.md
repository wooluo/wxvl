#  漏洞复现 | 东胜物流软件 OpSailingDateListHtmlGridSource.aspx 存在SQL注入漏洞  
 实战安全研究   2026-05-11 01:00  
...
东胜物流信息管理系统 OpSailingDateListHtmlGridSource.aspx 接口存在SQL注入漏洞，未经身份验证的远程攻击者除了可以利用SQL 注入漏洞获取数据库中的信息（例如，管理员后台密码、站点的用户个人信息）之外，甚至在高权限的情况可向服务器中写入木马，进一步获取服务器系统权限。  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtopTyicCe20iaxWDJP8Bg4bg4lXicDibYHBkXs9Mr7dynM1urBBcRzjeTwiaibHhfMDkztv54kP3uvF0xYL3YCPKaiactqrHRpLPx7KTXA/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtorw9Y8iaPOIpQ3TenaopOxlLyibIhHhbs9OCl4A7OoM2VicYAqNsYf97twDLXpGJ9VDqZC75ruYzJLxsaX8piaZmyDKWEJp3hC6TuE/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtorQL4M5EslYhzia0bCBNxsKcC2rRq8kR5pRicejavCMpDXANHlaZ3lnLIbkACamjY448wfrOAdU5sZan7cApypqtunXRh8WUOlho/640?wx_fmt=png&from=appmsg "")  
  
afrog  
  
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtoopKPqfzexMEhy7rYmQxcIWmAL8RgELZibUDYAgawZjnvoXAfYRib6yPo7EAOl0DANFYRNy4kgsicwrxWvpKBlvCLpMlTLY76btOs/640?wx_fmt=png&from=appmsg "")  
