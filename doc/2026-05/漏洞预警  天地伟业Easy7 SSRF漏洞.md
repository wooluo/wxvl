...
**简述：**  
天地伟业Easy7的/Easy7/apps/WebService/GetOtherDomainServer.jsp接口存在SSRF漏洞，攻击者可通过该漏洞诱导服务器发起任意HTTP/HTTPS请求，从而探测内网服务结构、访问受限接口，甚至在特定条件下实现对内网应用的数据窃取或进一步利用。  
