...
原创 森林之家zbs
                    森林之家zbs  allby森林之家   2026-09-10 12:55  
...
![](https://mmbiz.qpic.cn/mmbiz_png/2wf8V0A7uBeLFibjHb71HZeIHakrqouCFb6M7jS2icn1Bso7LU0vC20bjhG2jlvJWCCjHXMOZWicub9kxu4OIwFEia93G1ENGL4GYKNed5FQYH0/640?wx_fmt=png&from=appmsg "")  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/2wf8V0A7uBcMRKbzZ6uS9nvpAlBYR47AmMQuGVpCMxRLicnI0zd0T5WricUEIIicUpkAbQNX36ucX7LsnhcEdCxAgTmS21lQ29ESYnBzawPUII/640?wx_fmt=png&from=appmsg "")  
...
可以通过  
登录失败时bp抓包观察响应包是否有remeberMe=delete，如果有一般都是shiro登录框架。  
...
and extractvalue(1,concat(0x7e,(select table_schema from information_schema.tables limit 0,1),0x7e))  
...
##   
## 【8月网安之家其他​文章快通车】：  
## 每日一学：struts2框架，你必须知道的几个通用漏洞  
## shiro框架，你必须知道的三个通用漏洞  
## CTF 新手必学：SQL 注入（附8月份网安学习文章汇总）  
## Agent渗透测试技能一图流:10个渗透skills  
## 每日学习：如何破解Mysql数据库密码  
## 每日学习：文件上传漏洞的十个小场景【靶场】  
## 每日一学：如何对App进行渗透测试？  
##   
