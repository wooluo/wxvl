...
原创 洞悉安全团队
                    洞悉安全团队  洞悉安全团队   2026-03-31 12:30  
...
1. 预定该会议室需要购买附加服务，水：5元/人 ，投影3元/场，总计52元  
...
1. 提交申请后拦截数据包，数据包中包含了购买产品的信息，包括产品名称，商品id，商品价格等信息  
...
1. 思考：如果后端不是根据商品id去回显出商品信息，而是通过我们数据包中传入的商品信息去最终显示出商品信息，如果我们篡改商品信息，不修改商品id以及商品价格，是否可以做到低价购买高价商品  
  
1. 保留商品id以及商品价格，修改商品名称以及feeDesc，修改为价格更高的水，删除掉原本水的参数吗，下单  
...
1. 修改掉生成订单中的商品名称以及商品图片，保留商品id以及商品价格  
...
1. 成功利用低价购买了高价商品，并且商家会以该商品信息去发货  
...
[](https://mp.weixin.qq.com/s?__biz=MzkwNzY3MjkwNg==&mid=2247484378&idx=1&sn=cce951dcddbaa1d74efdf6452c081fb8&scene=21#wechat_redirect)  
