#  漏洞复现 | OpenCode content 接口任意文件读取漏洞  
 实战安全研究   2026-07-10 01:00  
...
OpenCode content 接口任意文件读取漏洞，未经身份验证的攻击者可以通过该漏洞读取服务器任意文件，未对用户输入进行充分过滤，可以通过构造包含目录遍历序列（如..;）的路径参数，读取服务器上的任意文件。成功利用此漏洞可导致服务器敏感信息泄露，例如系统配置文件、数据库凭证等关键数据，从而可能为进一步攻击提供便利。  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtopPcRNT8TDBIq0ud4k6801XxuHiculicsGDvrEiaziaMHatmrv4NrHbzxicpBYCwGKDg99JkHCRVn2XTTmFZTI2KowiacdZO9nAlCUK0/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtopZlicXqQDnONjVqIN0YmJAVdhmk5qBxauO2roiauDvpgXTYXhlnMdMOEUPpqbYbEiacgqpDAPw6UxLmqMJJM5QSic99qcTF5GibUMI/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtopLU05FibHB2qCtwOgb1TLfT1OibOR9AzdQxvibvzrqRFTXl44m8hgwicU8fSjPJCyOMafjKmG4KCOaK3ibdfiboW5tRCO4fCoS1icHia0/640?wx_fmt=png&from=appmsg "")  
  
afrog  
  
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtooyyhJAGuQOwRqelzW6Pp2c8mjia8ibIvcJIygsIcrua3xAN1j3iaUmA6vFChGTricpo9z60O3EqLq5JRHR1vgapZVex21TkrmPd60/640?wx_fmt=png&from=appmsg "")  
